...
print('-       ENTERING INTO THE FOREST ZONE       -')
print('-                                           -')
print('-    711521BCS039 - PriyaDharshini          -')
print('-    711521BCS054 - Sunil Prasad            -')
print('-    711521BCS055 - Surdhika                -')
print('-    711521BCS062 - Vishnu                  -')
print('---------------------------------------------')
...
# -- start Desktop app --
print('ANIMALS ARE WELCOMING YOU')
